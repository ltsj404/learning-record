...
func main() {
	...
	if err != nil {
		fmt.Println("无法解析开始时间", startTimeArg)
		return
	}

	queryFinishTime, err := time.Parse("2006-01-02T15:04:05.0000Z", finishTimeArg)
	if err != nil {
		fmt.Println("无法解析完成时间", finishTimeArg)
		return
	}

	filestat, err := file.Stat()
	if err != nil {
		fmt.Println("无法获取文件统计信息")
		return
	}
	...
	if lastLogCreationTime.After(queryStartTime) && lastLogCreationTime.Before(queryStartTime) {
